...
nitpick.perform("Read GLTF model", Script.resolvePath("."), "secondary", function(testType) {
    ...
    var testEntity = Entities.addEntity({
        ...
        modelURL: 'https://raw.githubusercontent.com/KhronosGroup/glTF-Sample-Models/master/2.0/BoxInterleaved/glTF-Binary/BoxInterleaved.glb',
    ...
    nitpick.addStepSnapshot("BoxInterleaved.glb Model is visible");
