// a temporary test to repo the potential LOD/culling issue with an FBX model
...
nitpick.perform("Read GLTF model", Script.resolvePath("."), "secondary", function(testType) {
    ...
    var testEntity = Entities.addEntity({
        lifetime: LIFETIME,
        type: "Model",
        modelURL: assetsRootPath + 'models/xl2.fbx',
    ...
    nitpick.addStepSnapshot("xl2.fbx Model is visible");
