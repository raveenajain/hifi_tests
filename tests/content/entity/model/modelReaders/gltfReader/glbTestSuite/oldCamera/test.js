...
nitpick.perform("Read GLTF model", Script.resolvePath("."), "secondary", function(testType) {
    ...
    var testEntity = Entities.addEntity({
        lifetime: LIFETIME,
        type: "Model",
        // https://github.com/KhronosGroup/glTF-Sample-Models/tree/master/2.0/AntiqueCamera
        ...
        position: Vec3.sum(position, {x: 0.0, y: 1.0, z: -0.8 }),
    ...
    nitpick.addStepSnapshot("AntiqueCamera.glb Model is visible");
